...
<svg xmlns="http://www.w3.org/2000/svg" width="520" height="120" role="img" aria-label="Last commit (JST)">
  ...
  <text x="20" y="40" font-family="Inter, Arial, sans-serif" font-size="16" font-weight="600" fill="#9AA4AE">
    LAST COMMIT (JST) · ${DOW_JST}
  </text>
  <text x="20" y="85" font-family="JetBrains Mono, Menlo, Consolas, monospace"
        font-size="34" font-weight="800" fill="#36BCF7">
    ${DATE_JST}  ${TIME_JST}
  </text>
</svg>
EOF
